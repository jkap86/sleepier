...
function instrumentationsLoaded() {
    const globallyStoredClient = client_1.Client.client;
    if (globallyStoredClient) {
        return globallyStoredClient.instrumentationsLoaded;
    }
    else {
        client_1.Client.integrationLogger.debug("Client is not initialized, cannot get OpenTelemetry instrumentations loaded");
