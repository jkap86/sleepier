...
class Diagnose {
    ...
    async run() {
        ...
        console.log(`  Validating Push API key: ${this.colorize(data["validation"]["push_api_key"])}`);
        this.print_newline();
        console.log(`Paths`);
        ...
        if (process.argv.includes("--no-send-report")) {
            console.log(`  Not sending report. (Specified with the --no-send-report option.)`);
        }
            ...
            const self = this;
            rl.question(`  Send diagnostics report to AppSignal? (Y/n): `, async function (answer) {
    ...
    async sendReport(data) {
        ...
        console.log("");
        await tslib_1.__classPrivateFieldGet(this, _diagnose).sendReport(data);
    }
