...
function demo(client) {
    const { sec: startSec, nsec: startNsec } = utils_1.hrTime();
    const traceId = crypto_1.randomBytes(10).toString("base64");
    const rootSpanId = crypto_1.randomBytes(10).toString("base64");
    const childSpanId = crypto_1.randomBytes(10).toString("base64");
    // Performance sample
    ...
    // Error sample
    const errorTraceId = crypto_1.randomBytes(10).toString("base64");
    const errorRootSpanId = crypto_1.randomBytes(10).toString("base64");
