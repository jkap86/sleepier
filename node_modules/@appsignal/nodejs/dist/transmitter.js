...
class Transmitter {
    constructor(url, body = "") {
        ...
        tslib_1.__classPrivateFieldSet(this, _config, new config_1.Configuration({}));
        tslib_1.__classPrivateFieldSet(this, _url, url);
        tslib_1.__classPrivateFieldSet(this, _body, body);
    }
    downloadStream() {
        ...
        return stream => {
            ...
            if (isRedirect && typeof newURL !== "undefined") {
                ...
                if (redirectCount >= MAX_REDIRECTS) {
                    ...
                    const newTransmitter = new Transmitter(newURL, tslib_1.__classPrivateFieldGet(this, _body));
    ...
    configParams() {
        const config_data = tslib_1.__classPrivateFieldGet(this, _config).data;
    ...
    writeRequest(method, request) {
        if (method == "POST") {
            request.write(tslib_1.__classPrivateFieldGet(this, _body));
        }
    }
    urlRequestOptions() {
        const requestUrl = new url_1.URL(tslib_1.__classPrivateFieldGet(this, _url));
        return {
    ...
    bodyRequestOptions(method) {
        ...
        return {
            headers: {
                ...
                "Content-Length": tslib_1.__classPrivateFieldGet(this, _body).length
            }
        };
    }
    caRequestOptions(protocol) {
        if (protocol != "https:")
            return {};
        const configData = tslib_1.__classPrivateFieldGet(this, _config).data;
...
_config = new WeakMap(), _url = new WeakMap(), _body = new WeakMap();
