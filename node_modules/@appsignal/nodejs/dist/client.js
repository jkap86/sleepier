...
class Client {
    ...
    constructor(options = {}) {
        ...
        if (this.isActive) {
            ...
            tslib_1.__classPrivateFieldSet(this, _metrics, new metrics_1.Metrics());
            tslib_1.__classPrivateFieldSet(this, _sdk, this.initOpenTelemetry(options.additionalInstrumentations || []));
        }
        else {
            tslib_1.__classPrivateFieldSet(this, _metrics, new noops_1.NoopMetrics());
    ...
    stop(calledBy) {
        ...
        (_a = tslib_1.__classPrivateFieldGet(this, _sdk)) === null || _a === void 0 ? void 0 : _a.shutdown();
     ...
     */
    metrics() {
        return tslib_1.__classPrivateFieldGet(this, _metrics);
    }
    logger(group, level) {
        if (this.isActive) {
            return new logger_1.BaseLogger(this, group, level);
        }
        else {
            return noops_1.noopLogger;
        }
    ...
    initCoreProbes() {
        ...
        // load probes
        probes.forEach(({ PROBE_NAME, init }) => tslib_1.__classPrivateFieldGet(this, _metrics).probes().register(PROBE_NAME, init(tslib_1.__classPrivateFieldGet(this, _metrics))));
    }
                ...
                requestHook: function (_span, info) {
                    if (info.layerType === instrumentation_express_1.ExpressLayerType.REQUEST_HANDLER) {
                        if (sendParams) {
                            ...
                            helpers_1.setParams(params);
                        }
                        if (sendSessionData) {
                            helpers_1.setSessionData(info.request.cookies);
                        }
                    }
                }
            },
            ...
            "@opentelemetry/instrumentation-koa": {
                requestHook: function (span, info) {
                    if (sendParams && info.layerType === instrumentation_koa_1.KoaLayerType.ROUTER) {
                        ...
                        helpers_1.setParams(queryParams, span);
                    }
                }
            },
            ...
            "@opentelemetry/instrumentation-restify": {
                requestHook: (span, info) => {
                    if (sendParams &&
                        ...
                        helpers_1.setParams(params, span);
                    }
                }
            },
...
_metrics = new WeakMap(), _sdk = new WeakMap();
