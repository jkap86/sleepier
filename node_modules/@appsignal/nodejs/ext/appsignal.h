 ...
 * @param nsec Nanoseconds since second-based timestamp
 */
appsignal_span_t* appsignal_create_child_span_with_timestamp(appsignal_span_t*, long, long);
 ...
 */
void appsignal_log(appsignal_string_t, int, appsignal_string_t, appsignal_data_t*);
